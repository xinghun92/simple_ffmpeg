...
#define FFMPEG_CONFIGURATION "--prefix=/tmp/ffmpeg_prebuilt --enable-debug --disable-stripping --enable-static --disable-shared --enable-pic --disable-programs --disable-gpl --disable-version3 --disable-nonfree --enable-avcodec --enable-avdevice --enable-avfilter --enable-avformat --enable-avresample --disable-postproc --enable-swresample --enable-swscale --arch=i386 --toolchain=msvc --extra-cflags=-MTd extra-cxxflags=-MTd --extra-ldflags='-nodefaultlib:LIBCMT'"
...
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.00.24210 for x86"
